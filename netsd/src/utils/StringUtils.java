 ...
 * versa</li>
 * <li><b>Replace/Delete/Overlay </b>- Searches a String and replaces one
 * String with another</li>
 ...
 * another</li>
 * <li><b>IsAlpha/IsNumeric/IsWhitespace </b>- checks the characters in a
 * String</li>
 ...
 * @author Phil Steitz
 * @since 1.0
 * @version $Id: StringUtils.java,v 1.1 2010/01/20 11:39:41 yezy Exp $
 */
public class StringUtils {
     ...
     */
    /*
     * public static String deleteSpaces(String str) { if (str == null) { return
     * null; } return CharSetUtils.delete(str, " \t\r\n\b"); }
     */
     ...
     */
    /*
     * public static String capitaliseAllWords(String str) { return
	 ...
	 * @return
	 */
	public static int getLocate(String value,String[] source)
	{
		int i = 0 ;
		for (; i < source.length ; i++)
		if (value.equalsIgnoreCase(source[i])) return i ;
		return i ;
	}
