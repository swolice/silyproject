...
//  document.domain="it168.com"
  ...
  this.add =  function(obj){ 
	  ...
	  var adstyle="";
	  aditem.ifmurl="http://adshow.it168.com/adfile/advs_publish_v5.asp?id="+aditem.id+(aditem.adv_ctc!=""?"&ctc="+aditem.adv_ctc:"")+(aditem.adv_cbc!=""?"&cbc="+aditem.adv_cbc:"")+"&ifm="+aditem.adv_ifm+"&w="+aditem.adv_w+"&h="+aditem.adv_h+"&btn_cls="+aditem.btn_cls+"&st="+aditem.adv_st+"&tmp="+aditem.adv_tmp+"&tmpid="+aditem.adv_tmpid+"&adv_id="+aditem.adv_id+"&classname="+aditem.classname;
      ...
      if(ua.indexOf('msie')!=-1){
          ...
          aditem.adhtml="<span style='display:block;"+adstyle+"' id="+aditem.adv_sid+">"+"<iframe name='"+aditem.adv_ifm+"' id='"+aditem.adv_ifm+"' style='height:"+aditem.adv_h+"px;width:"+aditem.adv_w+"px;display:block;' src='"+aditem.ifmurl+"' noresize scrolling=No frameborder=0 marginheight=0 marginwidth=0 allowTransparency='true'></iframe></span>"			
	  }
	  else{
		  aditem.adhtml="<span style='display:none;"+adstyle+"' id="+aditem.adv_sid+">"+"<iframe name='"+aditem.adv_ifm+"' id='"+aditem.adv_ifm+"' style='height:"+aditem.adv_h+"px;width:"+aditem.adv_w+"px;display:none;' src='"+aditem.ifmurl+"' noresize scrolling=No frameborder=0 marginheight=0 marginwidth=0 allowTransparency='true'></iframe></span>"	
	  }
