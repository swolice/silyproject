...
public class notice02 implements IReportLocic,Runnable{
	...
	public void setExcelSTLWrite(ExcelSTLWrite _excelSTLWr, int _sidx) {
		...
		this.sidx = _sidx;
		excel.setExcelTempRptXml("F:/crmwork/20100308Accout/CRMXML/xmltemp/notice-02.xml");
