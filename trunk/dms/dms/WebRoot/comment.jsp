...
<br>
  ...
  <tr> 
  <td width="110">
  <a href="index.do?method=detail&id=${obj.infoId}" target="_blank">
  	<img src="<mytld:infoPicTag infoId="${obj.infoId}"></mytld:infoPicTag>" width="100" height="80">
  	</a>
  </td>
  ...
  <tr>
  	<td colspan="2">
  		<mytld:turnPage name="page" action="home.do?method=comment&type=0" formName="commentForm"></mytld:turnPage>
  	</td>
  </tr>
  </table>
  <br>
  ...
  <tr> 
  <td width="110">
  <a href="index.do?method=detail&id=${obj1.infoId}" target="_blank">
  	<img src="<mytld:infoPicTag infoId="${obj1.infoId}"></mytld:infoPicTag>" width="100" height="80"></a>
  </td>
...
<a href="home.do?method=sendMsg&tid=${obj1.userId}" target="_blank"><mytld:userTag userId="${obj1.userId}"></mytld:userTag></a> (<fmt:formatDate value="${obj1.createTime}" pattern="M月d日 HH时mm分"/>)</td>
  <td><input type="button" value="参与评论" class='submit_button' onclick="location.href='index.do?method=detail&id=${obj1.infoId}#commentDiv'"/></td>
  </tr>
    </c:forEach>
  </c:if>
  </table>
