...
public class _mymsg__jsp extends com.caucho.jsp.JavaPage
{
   ...
   request.setAttribute("SESSION_CITY",session.getAttribute("SESSION_CITY"));
	...
	if (session.getAttribute("SESSION_USER")!=null){
      ...
      if (_caucho_expr_1.evalBoolean(_jsp_env)) {
        ...
        while (_jsp_iter_5.hasNext()) {
          ...
          if (_jsp_FormatDateTag_1 == null) {
            ...
            _jsp_FormatDateTag_1.setPattern("M\u6708d\u65e5 HH\u65f6mm\u5206");
          }

          _jsp_FormatDateTag_1.setValue((java.util.Date) _caucho_expr_6.evalObject(_jsp_env));
      ...
      if (_jsp_PageTag_2 == null) {
        ...
        _jsp_PageTag_2.setAction("home.do?method=msg");
        _jsp_PageTag_2.setFormName("commentForm");
      }
    ...
    throws ServletException
  {
    ...
    _caucho_expr_3 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${obj.readFlag==0?\"*\":\"&nbsp;\"}");
    _caucho_expr_4 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${obj.title}");
    _caucho_expr_5 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${obj.content}");
    _caucho_expr_6 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${obj.createTime}");
  }
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("mymsg.jsp"), 7684690145077996583L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
