...
public class _citylist__jsp extends com.caucho.jsp.JavaPage
{
    ...
    throws java.io.IOException, javax.servlet.ServletException
  {
    ...
    try {
      ...
      if (_jsp_PageTag_0 == null) {
        ...
        _jsp_PageTag_0.setAction("city.do?method=list");
        _jsp_PageTag_0.setFormName("cityListForm");
      }
    ...
    throws ServletException
  {
    ...
    _caucho_expr_2 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${obj.cityName}");
    _caucho_expr_3 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${obj.sortOrder}");
    _caucho_expr_4 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${obj.cityGroup}");
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("bms/cityList.jsp"), -3028673406630275553L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
