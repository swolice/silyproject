...
public class _regok__jsp extends com.caucho.jsp.JavaPage
{
	...
	if (session.getAttribute("SESSION_USER")!=null){
      ...
      if (_caucho_expr_1.evalBoolean(_jsp_env)) {
        ...
        while (_jsp_iter_5.hasNext()) {
          ...
          out.write(_jsp_string18, 0, _jsp_string18.length);
          pageContext.defaultSetOrRemove("_num", _caucho_expr_9.evalObject(_jsp_env));
    ...
    throws ServletException
  {
    ...
    _caucho_expr_3 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${index.index%2==0}");
    _caucho_expr_4 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${obj.siteId}");
    _caucho_expr_5 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${obj.sellPrice/100}");
    _caucho_expr_6 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${obj.discount/100}");
    _caucho_expr_7 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${obj.title}");
    _caucho_expr_8 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${index.index%2==1}");
    _caucho_expr_9 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${index.index}");
    _caucho_expr_10 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${_num%2==0}");
  }
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("regok.jsp"), -6372702251453240747L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
    depend = new com.caucho.vfs.Depend(appDir.lookup("header.jsp"), 6523876953922704291L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string19 = "  \r\n	".toCharArray();
    _jsp_string25 = "\u6298 </span><br> <span class=\"intro\">".toCharArray();
    _jsp_string8 = "\">".toCharArray();
    _jsp_string30 = "\r\n<td></td></tr>\r\n".toCharArray();
    _jsp_string23 = "</a> ]&nbsp;&nbsp;<span class=\"discount\">\u4ec5\u552e".toCharArray();
    _jsp_string22 = "\" target=\"_blank\">".toCharArray();
