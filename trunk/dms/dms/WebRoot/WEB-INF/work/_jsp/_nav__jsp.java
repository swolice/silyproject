...
public class _nav__jsp extends com.caucho.jsp.JavaPage
{
    ...
    throws java.io.IOException, javax.servlet.ServletException
  {
   ...
   request.setAttribute("SESSION_CITY",session.getAttribute("SESSION_CITY"));
	...
	if (session.getAttribute("SESSION_USER")!=null){
      ...
      _jsp_CityTag_0.setCityId(new java.lang.Long(_caucho_expr_6.evalLong(_jsp_env)));
      _jsp_CityTag_0.doStartTag();
      ...
      if (_caucho_expr_7.evalBoolean(_jsp_env)) {
        ...
        _jsp_loop_0.init(0, Integer.MAX_VALUE, 1);
        Object _jsp_status_10 = pageContext.putAttribute("index1", _jsp_loop_0);
        Object _jsp_oldVar_10 = pageContext.getAttribute("obj1");
        while (_jsp_iter_10.hasNext()) {
          Object _jsp_i_10 = _jsp_iter_10.next();
          pageContext.setAttribute("obj1", _jsp_i_10);
        ...
        pageContext.pageSetOrRemove("obj1", _jsp_oldVar_10);
    ...
    throws ServletException
  {
    ...
    _caucho_expr_4 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${(obj.hot==0)?(\"class=hot_city\"):(\"\")}");
    _caucho_expr_5 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${obj.cityName}");
    _caucho_expr_6 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${cityId}");
    _caucho_expr_7 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${list1!=null&&!empty list1}");
    _caucho_expr_8 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${list1}");
    _caucho_expr_9 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${obj1.url}");
    _caucho_expr_10 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${obj1.siteId}");
  }
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("nav.jsp"), 2670530821371306919L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string25 = "    \r\n          <div class=\"clear\"></div>\r\n     </div>\r\n        \r\n          <div class=\"category_sites changsha_sites\" >\r\n            <h3 class=\"title\">".toCharArray();
    _jsp_string19 = "\r\n			".toCharArray();
    _jsp_string21 = "\" ".toCharArray();
    _jsp_string23 = "</a>          \r\n	     ".toCharArray();
    _jsp_string20 = "\r\n            <a href=\"index.do?method=city&id=".toCharArray();
    ...
    _jsp_string28 = "\"  class=\"site_link\" target=\"_blank\">".toCharArray();
