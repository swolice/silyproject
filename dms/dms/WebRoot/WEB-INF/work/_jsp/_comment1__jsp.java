...
public class _comment1__jsp extends com.caucho.jsp.JavaPage
{
    ...
    throws java.io.IOException, javax.servlet.ServletException
  {
    ...
    dms.tag.DomainPicTag _jsp_DomainPicTag_1 = null;
	...
	if (session.getAttribute("SESSION_USER")!=null){
      ...
      if (_caucho_expr_1.evalBoolean(_jsp_env)) {
        ...
        while (_jsp_iter_5.hasNext()) {
          ...
          if (_jsp_DomainPicTag_1 == null) {
            _jsp_DomainPicTag_1 = new dms.tag.DomainPicTag();
            _jsp_DomainPicTag_1.setPageContext(pageContext);
            _jsp_DomainPicTag_1.setParent((javax.servlet.jsp.tagext.Tag) _jsp_loop_0);
          }

          _jsp_DomainPicTag_1.setDomainId(new java.lang.Long(_caucho_expr_3.evalLong(_jsp_env)));
          _jsp_DomainPicTag_1.doStartTag();
      ...
      if (_jsp_PageTag_3 == null) {
        ...
        _jsp_PageTag_3.setAction("home.do?method=comment&type=1");
      ...
      if (_caucho_expr_6.evalBoolean(_jsp_env)) {
        ...
        while (_jsp_iter_18.hasNext()) {
          ...
          _jsp_DomainPicTag_1.setDomainId(new java.lang.Long(_caucho_expr_8.evalLong(_jsp_env)));
          _jsp_DomainPicTag_1.doStartTag();
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("comment1.jsp"), 8876346961202966068L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
    ...
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, new com.caucho.make.ClassDependency(dms.tag.DomainPicTag.class, 1745145604352515286L));
  ...
  static {
    ...
    _jsp_string31 = ")</td>\r\n  <td><input type=\"button\" value=\"\u53c2\u4e0e\u8bc4\u8bba\" class='submit_button' onclick=\"location.href='index.do?method=site&id=".toCharArray();
