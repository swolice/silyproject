 ...
 * 需要用到JCE的几个包
 *
 * @author <a href="jing.huang@dudu-inc.com">Huang Jing</a>
 */
public class MathUtil {
  private static String COMMON_KEY = "chonglinshigehaohaizi";
  ...
  public static void main(String[] args) {
    String s = "测速";
    String key = "test";
    String result = encryptAsString(s, key);
    System.out.println("result : " + result);
    String ss = desEncryptAsString(result, key);
