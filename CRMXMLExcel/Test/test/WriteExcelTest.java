...
//            writeExcelUseFormat("c:\\format.xls","test");
             ...
             buildNewFormTemplete(new File("c:/finishBatch-test.xls"),new File("c:/buildNewFormTemplete.xls"));
...
//        wrappedText.setWrap(true);// 可换行的label样式
        for(int i=4;i<20;i++) {
            Label label = new Label(4, i, ""); // "\012"强制换行
            WritableCellFeatures features = new WritableCellFeatures();
        	List angerlist = new ArrayList();
        	angerlist.add("电话");
        	angerlist.add("手机");
...
//    	
    ...
    public static ArrayList sampleReadExcel(File inputFile,
